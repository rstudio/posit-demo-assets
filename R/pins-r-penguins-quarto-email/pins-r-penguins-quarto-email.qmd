...
Here is a Quarto document that renders to HTML and also produces a custom email message with [an attachment](https://docs.posit.co/connect/user/quarto/#attachments). learn more aout it here <https://quarto.org/>. 
...
user <- "lisa.anders" # Sys.getenv("USER") # rstudio-connect
...
## Deploying to Connect programmatically 

```{r}
# # Deploy it, this example is all self contained with no runtime
# app_name <- "quarto-email-simple-deploy"
# app_dir <- local_temp_app(list(
#   "index.qmd" = c(
#     "---",
#     "title: Quarto Custom Email",
#     "format: email",
#     "email-attachments:",
#     "  - data.csv",
#     "---",
#     "This is a Quarto document creating custom email",
#     "",
#     "::: {.email}",
#     "::: {.subject}",
#     "Important Message",
#     ":::",
#     "",
#     "This message is so important, you must read it immediately!",
#     ":::"
#   ),
#   "data.csv" = c(
#     '"Name","Value"',
...
# ))
# 
# # Check that we can access the attachment
# attachment_url <- paste0(app_url, "data.csv")
# response <- GET(
#   url = attachment_url,
#   authenticate(CONNECT_ADMIN_USERNAME, CONNECT_ADMIN_PASSWORD)
# )
```
